    ...
    <!-- Optional JavaScript -->
      ...
      <script>
	  	...
	  	function doModify(id){
	  		window.location.href="majorModify.jsp?id="+id;
	  	}
	  	function doDelete(id){
	  		if(confirm("请确认是否删除该信息?")){
	  			$.ajax({
	  	            ...
	  	            data: {id:id,method:"doMajorDelete"},
	  	            success: function(data){
	  	            	if(data=="true"){
	  	            		alert("专业信息删除成功!");
	  	            		window.location.href="majorModify.jsp";
	  	            		return;
	  	            	}
	  	        		alert("专业信息删除失败,请稍后重试!");
	  	            }
	  	        });	
	  		}
	  	}
