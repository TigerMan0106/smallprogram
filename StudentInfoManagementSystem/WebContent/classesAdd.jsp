	...
	<div class="iq-card">
      ...
      <div class="iq-card-body">
         <form>
            ...
            <div class="form-group">
               <label for="pwd">班级辅导员</label>
               <input type="text" class="form-control" id="people">
            </div>
            <div class="form-group">
               <label for="pwd">班级辅导员联系方式</label>
      ...
      <script>
	    $(function(){
	  		...
	  		$("#btn_submit").bind("click",function(){
	    		...
	    		var phone=$("#phone").val();
	    		//检查填写信息
	    		if(cid.length==0 || name.length==0 || people.length==0 || phone.length==0){
	    			alert("您还没有补全信息喔!");
	    		}else{
	    			//开始提交后台处理录入信息
	        		$.ajax({
	                    ...
	                    data: {method:"doClassesAdd",cid:cid,name:name,people:people,phone:phone},
